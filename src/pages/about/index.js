          ...
          <div className="row2">
            <div className="grid-container">
              ...
              <div className="col-12">
                <h4>ABOUT US</h4>
                <hr className="mb-2"/>
                <h1 className="pt-1 pb-1">About the Magazine</h1>
                <p><i><b>Haven Spec</b></i> is a speculative fiction magazine featuring stories for a 21st century audience. We love stories with a sense of adventure, stories that teach us, that touch us, that leave us wanting more. We publish six issues every year, two of which (the DRY Issue and the WET Issue) are focused exclusively on the climate crisis and themes of displacement (very broadly defined).</p>
                ...
                <p className="pb-1">It's not too late.</p>
                <div>
                  <Link to="/subscribe">
              ...
              {/* ABOUT THE EDITORS SECTION */}
                ...
                {headEditors.map((headEditor, index) => (
                  <div key={index} className="editor-entry mb-2">
              ...
              <h1 className="pt-1 pb-1">About the Assistant Editors</h1>
              ...
              {/* ABOUT THE ASSOCIATE EDITORS SECTION */}
              <h1 className="pt-1 pb-1">About the Assistant Editors</h1>
                ...
                <h1 className="pt-1 pb-1">Privacy Policy</h1>
                ...
                <p className="pb-1">We hope that clears things up.</p>
                <hr className="mb-2 mt-4"/>

                <h1 className="pt-1 pb-1">Anti-Harassment Policy</h1>
                ...
                <p className="pb-1">This anti-harassment policy was largely cribbed from that of the non-profit group Americans for the Arts. We aren't affiliated in any way.</p>
                <hr className="mb-2 mt-4"/>

                <h1 className="pt-1 pb-1">Contact Us</h1>
                ...
                <p className="pb-1">Use this power only for good.</p>
                <iframe className="iframeContact" src="https://www.cognitoforms.com/f/GtTjHOYx10OF7APqunHRFw/6"></iframe>
                <hr className="mb-4" />

                <p className="mb-4">Interested to know how this website was put together? Want to get a (free!) copy of the website and our backend systems of your own? <Link to="/about-this-site">Click here!</Link></p>
              </div>
            </div>
          </div>
        </div>
