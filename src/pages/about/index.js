          ...
          <div className="row2">
            <div className="grid-container">
              ...
              <div className="ninety-percent">
                <h4 className='title-margin'>ABOUT US</h4>
                <hr className="mb-2"/>
              <div className='contributor-div'>
                ...
                <Link to="/subscribe">
                    <Image className="advertLong mb-4" fixed={data.advertLong.childImageSharp.fixed} />
                  </Link>
                </div>

              {/* ABOUT THE EDITORS SECTION */}
                <h1 className="pt-4 pb-1">About the Editor</h1>
                {headEditors.map((headEditor, index) => (
                  <div key={index} className="contributor-div">
              ...
              <h1 className="pt-4 pb-1">About the Assistant Editors</h1>
