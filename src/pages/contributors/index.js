...
const Contributors = (props) => {                                                  //this one is somehow creating the /contributors page independent of gatsby-node
      ...
      <div className="container pt-md-5">
        <div className="row2 justify-content-start">
          ...
          <div className="container">
            {posts
              .filter(post => post.node.frontmatter.category === "contributor")
              .map(({ node: post }) => {
                return (
